class Enigma {
    ...
    /**
     * Gets current position of rotors
     * @param {*} rotor 
     * @param {*} val Array containing positions of rotors
     */
    getRotPos(rotor, val) {
        var pos = [];
    ...
    */
    ...
    /**
     * Changes given rotor's ring setting
     * @param {*} rotor Rotor to change
     * @param {*} val The value to change ring to
     */
